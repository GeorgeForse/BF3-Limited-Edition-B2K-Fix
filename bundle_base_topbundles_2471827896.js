 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-hsla-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-applicationcache-canvas-canvastext-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websockets-websqldatabase-webworkers-cssclasses-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-css_filters-css_positionsticky-load
 */
;
...
;;(function($) {
    ...
    $.eventEmitter = {
        trigger: makeProxy( "trigger" ),
        one: makeProxy( "one" ),
        on: makeProxy( "on" ),
        off: makeProxy( "off" )
    };

    $.makeEventEmitter = function(owner) {
        owner._JQ = $('<dummy/>');
        $.extend(owner, $.eventEmitter);
    }
}(jQuery));;/* This file add support for legacy methods that are now natively supported in all browsers we support */
;(function($){
   // These alias functions replaces jquery.json which is no longer necessary
   $.evalJSON = JSON.parse;
